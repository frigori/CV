...
\begin{center}
  ...
  {\large\color{accent} Étudiant en Master Artificial Intelligence | Diplômé en Génie Informatique}\\[0.7em]
  \textcolor{lightgray}{
...
Diplômé en ingénierie informatique à l'Université de Bologne et admis au Master en Artificial Intelligence de la même université, avec un intérêt marqué pour l'intelligence artificielle, le machine learning et l'analyse de données. Ma formation m'a donné des bases solides en algorithmique, statistiques, systèmes et génie logiciel, que j'ai appliquées dans un contexte de recherche lors d'un semestre Erasmus en France. Motivé par la conception de systèmes intelligents pour résoudre des problèmes concrets, je poursuis mon parcours en Master pour approfondir mes compétences techniques et scientifiques.

%--- FORMATION ---%
\section{Formation}

\entry{Master en Artificial Intelligence}{2026 -- 2028 (Admis)}{Université de Bologne}
{Admis au programme de Master pour l'année académique 2026/2027.}
